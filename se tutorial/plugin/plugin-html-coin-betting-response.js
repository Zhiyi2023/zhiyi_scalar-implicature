var jsPsychHtmlCoinBettingResponse = (function (jspsych) {
    ...
    class HtmlCoinBettingResponsePlugin {
        ...
        trial(display_element, trial) {
            ...
            var html = '<div id="jspsych-html-coin-betting-response-wrapper" style="text-align: center;">';
            ...
            for (var j = 0; j < trial.images.length; j++) {
              html += '<td style="padding-bottom:20px;" class="jspsych-betting-col-' + j + '"><img id="jspsych-betting-img-' + j + '" src="' + trial.images[j] + '" style="width: 130px; height: 130px;"></td>';
            }
            html += '</tr>';
